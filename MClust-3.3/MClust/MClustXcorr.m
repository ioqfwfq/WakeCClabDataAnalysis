...
ts1 = Range(ExtractCluster(MClust_TTData, FindInCluster(MClust_Clusters{a}, MClust_FeatureData)),'ts');
ts2 = Range(ExtractCluster(MClust_TTData, FindInCluster(MClust_Clusters{b}, MClust_FeatureData)),'ts');
